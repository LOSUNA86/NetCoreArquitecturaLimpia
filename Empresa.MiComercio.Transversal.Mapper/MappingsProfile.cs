...
namespace Empresa.MiComercio.Transversal.Mapper
{
    public class MappingsProfile : Profile
    {
        public MappingsProfile()
        {
            ...
            CreateMap<Customers, ResponseCustomer>().ReverseMap();
            CreateMap<Users, ResponseLogin>().ReverseMap();
            CreateMap<Categories, ResponseCategorie>().ReverseMap();
