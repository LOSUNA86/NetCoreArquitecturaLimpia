    ...
    public class CustomersRepository : ICustomersRepository
    {
        ...
        public Customers Get(string customerId)
        {
            using (var connection = _context.CreateConnection())
            {
                ...
                var customer = connection.QueryFirstOrDefault<Customers>(query, param: parameters, commandType: CommandType.StoredProcedure);
                return customer;
            }
        }
        ...
        public async Task<Customers> GetAsync(string customerId)
        {
            using (var connection = _context.CreateConnection())
            {
                ...
                var customer = await connection.QueryFirstOrDefaultAsync<Customers>(query, param: parameters, commandType: CommandType.StoredProcedure);
                return customer;
            }
        }
